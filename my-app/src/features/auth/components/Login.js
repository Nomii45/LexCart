...
//       bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 animate-gradient-x">
...
//             <h2 className="block mt-3 text-lg text-gray-700 text-center font-bold">
//               Login
//             </h2>

//             <form method="#" action="#" className="mt-10 space-y-6">
//               {/* Email */}
//               <input
//                 type="email"
//                 placeholder="Enter email"
//                 className="pl-3 mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-md 
//                 hover:bg-blue-100 focus:bg-blue-100 focus:ring-2 focus:ring-blue-400"
//               />
